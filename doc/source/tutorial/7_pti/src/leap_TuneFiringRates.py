...
if __name__ == '__main__':
    ...
    problem = ExternalProcessProblem(command='./main_TuneFiringRates.out', maximize=True)
    ...
    ##############################
    # We call LEAP's generic generational metaheuristic to perform evolution.
    # This is a high-level algorithm template that takes three major components:
    #   1. a problem to optimize,
    #   2. a representation of solutions,and
    #   3. a pipeline of evolutionary operators
